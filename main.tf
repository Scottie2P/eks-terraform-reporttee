...
locals {
  cluster_name = "reporttee-intelligence-eks"
}
...
module "vpc" {
  ...
  name = "reporttee-intelligence-vpc"
  ...
  private_subnets = ["10.1.0.0/17", "10.1.128.0/17"]
  public_subnets  = ["10.2.0.0/17", "10.2.128.0/17"]
